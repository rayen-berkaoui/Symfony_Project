...
final class HomeController extends AbstractController
{
    private function getStats(
        ...
        ?PanierRepository $panierRepository = null,
        ...
        // Add panier and reservation stats if repositories are provided
        if ($panierRepository) {
            $panierStats = $panierRepository->getStats();
            $stats['total_paniers'] = $panierStats['total'];
            $stats['paniers_en_attente'] = $panierStats['en_attente'];
        }

        if ($reservationRepository) {
            $reservationStats = $reservationRepository->getStats();
            $stats['total_reservations'] = $reservationStats['total'];
            $stats['reservations_payees'] = $reservationStats['paye'];
            $stats['revenue'] = $reservationStats['revenue'];
        }
    ...
    public function index(
        ...
        $recentReservations = $reservationRepository->findRecent(5);
